...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_food_entries_logged_date'), 'food_entries', ['logged_date'], unique=False)
    ...
    op.create_index(op.f('ix_macro_goals_effective_date'), 'macro_goals', ['effective_date'], unique=False)
    ...
    op.create_index(op.f('ix_weight_entries_logged_date'), 'weight_entries', ['logged_date'], unique=False)
